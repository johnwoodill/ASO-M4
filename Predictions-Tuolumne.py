...
def gen_predictions(proc_pred_dat):
    ...
    print(f"Saving: data/{waterbasin}/pred_data_elevation_prism_sinceSep_nlcd_Apr01_{min_year}_{max_year}_V2.parquet")
    pred_dat.to_parquet(f"data/{waterbasin}/pred_data_elevation_prism_sinceSep_nlcd_Apr01_{min_year}_{max_year}_V2.parquet", compression=None)

    # pred_dat = pd.read_parquet(f"data/{waterbasin}/pred_data_elevation_prism_sinceSep_nlcd_Apr01_{min_year}_{max_year}_V2.parquet")
    ...
    pred_dat_trained.to_parquet(f"data/{waterbasin}/predictions/NN-ASO-SWE-Apr01_{min_year}_{max_year}_V2.parquet", compression=None)
    print(f"Saved: data/{waterbasin}/predictions/NN-ASO-SWE-2010-2021_Apr01_{min_year}_{max_year}_V2.parquet")
    # pred_dat_trained = pd.read_parquet(f"data/{waterbasin}/predictions/NN-ASO-SWE-2010-2021_Apr01_{min_year}_{max_year}_V2.parquet")



pred_dates = generate_dates(1981, 2009, 4, 1)
...
pred_dates = generate_dates(1981, 2009, 6, 1)
pred_dates = generate_dates(2010, 2021, 6, 1)

# pred_dates = generate_dates(1981, 2021, 6, 1)
shape_loc = "data/shapefiles/tuolumne_watershed/Tuolumne_Watershed.shp"
waterbasin = "Tuolumne_Watershed"
